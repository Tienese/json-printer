    ...
    return (
        ...
        >
            {type === 'ADD' && (
                <>
                    ...
                    {MENU_ITEMS.map(opt => (
                        <button
                            key={opt.type}
                            className="w-full text-left px-4 py-2.5 text-sm theme-text flex items-center gap-3"
            ...
            {type === 'DELETE' && targetItem && (
                <button
                    className="w-full text-left px-4 py-2.5 text-sm text-red-600 flex items-center gap-3"
