...
| `calculation_method`     | `string`  | <p>The new calculation method. Defaults to “decaying\_average” if the Outcomes New Decaying Average Calculation Method FF is ENABLED then Defaults to “weighted\_average”</p><p>Allowed values: <code>weighted\_average</code>, <code>decaying\_average</code>, <code>n\_mastery</code>, <code>latest</code>, <code>highest</code>, <code>average</code></p> |
