...
| ------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `include[]`   | `string` | <ul><li><p><br></p><p>“students”: Associations to include with the group. Note: this is only available if you have permission to view users or grades in the course</p><p><br></p></li><li><p><br></p><p>“avatar\_url”: Include the avatar URLs for students returned.</p><p><br></p></li><li><p><br></p><p>“enrollments”: If ‘students’ is also included, return the section enrollment for each student</p><p><br></p></li><li><p><br></p><p>“total\_students”: Returns the total amount of active and invited students for the course section</p><p><br></p></li><li><p><br></p><p>“passback\_status”: Include the grade passback status.</p><p><br></p></li><li><p><br></p><p>“permissions”: Include whether section grants :manage\_calendar permission to the caller</p><p><br></p></li></ul><p>Allowed values: <code>students</code>, <code>avatar\_url</code>, <code>enrollments</code>, <code>total\_students</code>, <code>passback\_status</code>, <code>permissions</code></p> |
