...
| `role[]`               | `string`  | A list of enrollment roles to return. Accepted values include course-level roles created by the [Add Role API](https://developerdocs.instructure.com/services/canvas/roles#method.role_overrides.add_role) as well as the base enrollment types accepted by the ‘type\` argument above.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
