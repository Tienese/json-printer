...
| --------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `include_peer_review` | `boolean` | If true, includes peer review sub assignment information and overrides in the response. Requires the peer\_review\_grading feature flag to be enabled. |
