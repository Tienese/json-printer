...
| ----------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `include[]` | `string` | <ul><li><p><br></p><p>“course\_subject\_tabs”: Optional flag to return the tabs associated with a canvas\_for\_elementary subject course’s home page instead of the typical sidebar navigation. Only takes effect if this request is for a course context in a canvas\_for\_elementary-enabled account or sub-account.</p><p><br></p></li></ul><p>Allowed values: <code>course\_subject\_tabs</code></p> |
