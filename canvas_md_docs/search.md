...
| `exclude[]`            | `string`  | Array of ids to exclude from the search. These may be user ids or course/group ids prefixed with “course\_” or “group\_” respectively, e.g. [exclude\[\]=1\&exclude](https://developerdocs.instructure.com/services/canvas/resources/search)=2\&exclude\[]=course\_3                                                                                      |
