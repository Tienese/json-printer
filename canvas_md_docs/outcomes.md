...
| `calculation_method`     | `string`  | <p>The new calculation method. If the Outcomes New Decaying Average Calculation Method FF is ENABLED then “weighted\_average” can be used and it is same as previous “decaying\_average” and new “decaying\_average” will have improved version of calculation.</p><p>Allowed values: <code>weighted\_average</code>, <code>decaying\_average</code>, <code>n\_mastery</code>, <code>latest</code>, <code>highest</code>, <code>average</code></p> |
