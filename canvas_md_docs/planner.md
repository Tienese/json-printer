...
| `filter`           | `string` | <p>Only return items that have new or unread activity</p><p>Allowed values: <code>new\_activity</code></p>                                                                                                                                                                                                                                                                                 |
