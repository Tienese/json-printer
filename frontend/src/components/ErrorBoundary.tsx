        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-screen flex items-center justify-center theme-bg p-4">
                    <div className="max-w-md w-full theme-surface shadow-lg rounded-lg p-6 border border-red-200 dark:border-red-800">
                        ...
                        <button
                            ...
                            className="w-full bg-primary-blue text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                        >
                            Reload Application
                        </button>
                    </div>
